          ...
          <div className="lg:col-span-5">
             <SectionHeader 
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="p-8 rounded-[40px] bg-red-600 text-white relative overflow-hidden"
              >
           ...
           <div className="lg:col-span-7">
             ...
             >
                ...
                <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
                       ...
                       <input 
                         ...
                         className={`w-full bg-slate-50 dark:bg-slate-950 border py-4 px-6 rounded-2xl focus:outline-none focus:ring-2 transition-all font-medium text-slate-900 dark:text-white ${
                          errors.name 
                           ...
                           : 'border-slate-100 dark:border-slate-800 focus:ring-red-500/20 focus:border-red-500'
                         }`}
                       />
                       {errors.name && (
                   ...
                   <button 
                     type="submit"
                     disabled={isLoading}
                     className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-5 rounded-[24px] font-black text-xl flex items-center justify-center gap-3 shadow-2xl transition-all hover:bg-red-600 dark:hover:bg-red-500 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed group active:scale-[0.98]"
                   >
                     {isLoading ? (
                       <>
             ...
             >
                <a href={store.socialLinks.instagram} target="_blank" rel="noreferrer" className="hover:text-red-600 transition-colors"><Instagram size={28} /></a>
                <a href={store.socialLinks.facebook} target="_blank" rel="noreferrer" className="hover:text-red-600 transition-colors"><Facebook size={28} /></a>
