      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5">
             ...
             <div className="space-y-6 mb-12">
               {contactMethods.map((m, i) => (
                 <a 
                  key={i} 
                  href={m.link} 
                  className="flex items-center gap-6 p-8 rounded-[32px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:border-violet-500/30 transition-all group"
                 >
             ...
             <div className="p-8 rounded-[40px] bg-violet-600 text-white relative overflow-hidden">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white dark:bg-slate-900 rounded-[48px] p-10 md:p-16 border border-slate-100 dark:border-slate-800 shadow-2xl relative overflow-hidden">
               ...
               <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 py-4 px-6 rounded-2xl focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all font-medium text-slate-900 dark:text-white"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 py-4 px-6 rounded-2xl focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all font-medium text-slate-900 dark:text-white appearance-none">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 py-4 px-6 rounded-2xl focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all font-medium text-slate-900 dark:text-white resize-none"
                    ></textarea>
                  </div>

                  <button className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-5 rounded-[24px] font-black text-xl flex items-center justify-center gap-3 shadow-2xl transition-all hover:bg-violet-600 dark:hover:bg-violet-500 hover:text-white group active:scale-[0.98]">
            ...
            <div className="mt-12 flex items-center justify-center gap-8 text-slate-400">
               <a href={store.socialLinks.instagram} className="hover:text-violet-600 transition-colors"><Instagram size={28} /></a>
               <a href={store.socialLinks.facebook} className="hover:text-violet-600 transition-colors"><Facebook size={28} /></a>
               <a href="#" className="hover:text-violet-600 transition-colors"><Twitter size={28} /></a>
            </div>
          </div>
        </div>
      </div>
