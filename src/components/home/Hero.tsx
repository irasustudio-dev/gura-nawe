...
const stats = [
  { icon: ShieldCheck, label: 'Secure Deals', color: 'text-emerald-500' },
  { icon: Users, label: '100+ Sellers', color: 'text-blue-500' },
  { icon: Star, label: '4.9/5 Rating', color: 'text-amber-500' },
  { icon: Zap, label: 'Instant Connect', color: 'text-violet-500' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-lg mb-10 leading-relaxed">
              Unlock the potential of your digital empire. Purchase monetized YouTube channels, TikTok accounts, followers, and premium growth services directly through WhatsApp.
            </p>
          ...
          >
            ...
            <div className="relative z-10 w-full aspect-square max-w-lg mx-auto rounded-[48px] overflow-hidden shadow-2xl border-8 border-white dark:border-slate-800 rotate-3">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8 text-white">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-bold text-lg">Monetized Channel</span>
                </div>
            ...
            >
              <div className="text-right">
                ...
                <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Watch Hours</p>
              </div>
